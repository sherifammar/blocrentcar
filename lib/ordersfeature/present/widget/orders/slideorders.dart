...
// class Slideorders extends GetView<RecordController> {
//   final OrdersModel listdata;

//   const Slideorders({Key? key, required this.listdata}) : super(key: key);
...
class Slideorders extends StatelessWidget {
    final OrdersModel listdata;
  const Slideorders({super.key, required this.listdata});
